...
[Flor](https://github.com/floraison/flor) is a "Ruby workflow engine", flor-worklist is an extension to flor that adds a few database tables and Ruby classes to manage one or more worklists, where tasks are stored.
